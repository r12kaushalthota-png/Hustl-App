...
function PostScreenContent() {
  ...
  const [showFoodOrderSection, setShowFoodOrderSection] = useState(false);
  ...
  useEffect(() => {
    ...
    if (categoryParam && categoryParam !== prefilledCategory) {
      ...
      // Show food order section for food category
      setShowFoodOrderSection(categoryParam === 'food');
        ...
        {categories.map((cat) => (
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              setShowFoodOrderSection(cat.value === 'food');
            }}
            disabled={isLoading}
